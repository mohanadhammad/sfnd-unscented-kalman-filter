...
int main() {
    ...
    // std::string in_file_name_ = "/home/myoussef/workset/udacity/sfnd-unscented-kalman-filter/exercises/cpp/kf_lidar_tracking/dat/obj_pose-laser-radar-synthetic-input.txt";
    std::string in_file_name_ = "./dat/obj_pose-laser-radar-synthetic-input.txt";
